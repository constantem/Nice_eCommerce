...
<script>
	$(document).ready(function() { // Document is ready
		...
		$("#cancel").click(function() {
			...
			$.each($("input.inputable"), function(index,thisInput) {
				$(thisInput).val(
					$(thisInput).siblings("span.displayable").text()
				);
			});

			$.each($("select.inputable"), function(index,thisSelect) {
				const originalOption = $(thisSelect).siblings("span.displayable").text();
				$(thisSelect)
...
<body>
				...
				<header class="card-header">
					<div
						...
						<p class="card-header-title">
							<span class="icon"><i class="mdi mdi-ballot"></i></span> 課程 <span
								id="formError" style="color: red"></span>
						</p>
						<button class="button blue" type="button" id="edit">編輯</button>
					</div>
				</header>
				<div class="card-content">
					...
					<form:form id="springForm"
						...
						<div class="field">
							...
							<div class="control">
								<span class="displayable">${course.courseName}</span>
								<form:input id="courseName" class="input inputable"
									hidden="hidden" type="text" path="courseName"
						...
						<div class="field">
							...
							<div class="control">
								<span class="displayable">${course.courseStartDate}</span>
								<form:input id="courseStartDate" class="input inputable"
									hidden="hidden" type="date" path="courseStartDate"
						...
						<div class="field">
							...
							<div class="control">
								<span class="displayable">${course.courseClassAmount}</span>
								<form:input id="courseClassAmount" class="input inputable"
									type="text" hidden="hidden" path="courseClassAmount"
						...
						<div class="field">
							...
							<div class="control">
								<span class="displayable">${course.coursePeriod}</span>
								<form:input id="coursePeriod" class="input inputable"
									type="text" hidden="hidden" path="coursePeriod"
						...
						<div class="field">
							...
							<div class="control">
								<div class="select">
									...
									<form:select class="inputable" hidden="hidden" path="id">
						...
						<div class="field">
							...
							<div class="control">
								<div class="select">
									<span class="displayable">${course.room.roomNo}${course.room.roomName}</span>
									<form:select class="inputable" hidden="hidden" path="roomNo">
						...
						<div class="field">
							...
							<div class="control">
								<span class="displayable">${course.coursePrice}</span>
								<form:input class="input inputable" type="text" hidden="hidden"
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/resources/backstage/js/main.min.js?v=1628755089081"></script>
