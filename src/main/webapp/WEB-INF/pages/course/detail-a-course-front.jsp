...
$(document).ready(function () {
	$.ajax({
		url: $("#contextRoot").val() + "/detail/data",
		data: $("#courseId").val(),
		success: function (course) {
			// 教練名
			const coachName = course.coach.lastName+course.coach.firstName;
			$("#coach").val( coachName );
			// 
		}
	});
...
<body>
	...
	<input id="courseId" type="hidden" value="${id}">
                ...
                <div class="col-lg-8 posts-list">
                    ...
                    <div class="single-post row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <img class="img-fluid" src="${contextRoot}/resources/frontstage/img/blog/post-img1.jpg" alt="">
                                </div>
                                <div class="col-6">
                                    <img class="img-fluid" src="${contextRoot}/resources/frontstage/img/blog/post-img2.jpg" alt="">
                                </div>
                    ...
                    <div class="navigation-area">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-12 nav-left flex-row d-flex justify-content-start align-items-center">
                                <div class="thumb">
                                    <a href="#"><img class="img-fluid" src="${contextRoot}/resources/frontstage/img/blog/prev.jpg" alt=""></a>
                                </div>
                                <div class="arrow">
                            ...
                            <div class="col-lg-6 col-md-6 col-12 nav-right flex-row d-flex justify-content-end align-items-center">
                                ...
                                <div class="thumb">
                                    <a href="#"><img class="img-fluid" src="${contextRoot}/resources/frontstage/img/blog/next.jpg" alt=""></a>
                                </div>
                            </div>
                        </div>
                    </div>
