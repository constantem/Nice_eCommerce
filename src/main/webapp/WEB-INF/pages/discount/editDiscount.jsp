					...
					<div id="app">
						...
						<section class="is-hero-bar">
							<div class="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
								<h1 id="showTitle" class="title">修修你的優惠</h1>
...
<%-- 													<form:input path="discountCategory"></form:input> --%>
												</td>
											</tr>
					...
					<!-- 		<div class="col-9"> -->
					<!-- 			<div class="card"> -->
					<!-- 				<div class="card-header">編輯優惠</div> -->
					<!-- 				<div class="card-body"> -->

					<%-- <form:form class="form" method="POST" modelAttribute="discount"> --%>
