                                ...
                                <div class="col-lg-8 posts-list">
                                    <div class="single-post row">
                                        ...
                                        <div class="col-lg-9 col-md-9 blog_details">
                                            <h2>${dis.description}</h2>
                                            <p class="excert">
                                                ${dis.announcementBean.description}
                                            </p>
                                            <p>
                                                Boot camps have its supporters and its detractors. Some people do not
                                                understand why
                                                you should have to spend money on boot camp when you can get the MCSE
                                                study materials
                                                yourself at a fraction of the camp price. However, who has the willpower
                                                to actually
                                                sit through a self-imposed MCSE training. who has the willpower to
                                        ...
                                        <div class="col-lg-12">
                                            <div class="quotes">
                                                ...
                                                not understand
                                                why you should have to spend money on boot camp when you can get the
                                                MCSE study
