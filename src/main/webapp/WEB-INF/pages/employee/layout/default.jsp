...
<head>
  ...
  <link rel="stylesheet" href="${contextRoot}/resources/css/main.css?v=1628755089081">
  <link rel="stylesheet" href="${contextRoot}/resources/css/main.css">


  <link rel="mask-icon" href="${contextRoot}/resources/safari-pinned-tab.svg"/>
    ...
    <ul class="menu-list">
      ...
      <li>
        <a class="dropdown">
          ...
          <span class="menu-item-label">員工管理系統</span>
...
<script type="text/javascript" src="${contextRoot}/resources/js/main.min.js?v=1628755089081"></script>
