            ...
            <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
                <div class="col-first">
                    ...
                    <nav class="d-flex align-items-center">
                        ...
                        <a href="${contextRoot}/resources/frontstage/category.html">Blog</a>
                    </nav>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-8">
                    <div class="blog_left_sidebar">
                        <article class="row blog_item">
                            ...
                            <div class="col-md-9">
                                <div class="blog_post">
                                    <img src="${contextRoot}/resources/frontstage/img/blog/main-blog/m-blog-1.jpg" alt="">
                                    <div class="blog_details">
                                        ...
                                        <a href="${contextRoot}/resources/frontstage/single-blog.html" class="white_bg_btn">View More</a>
                                    </div>
                                </div>
                            </div>
                        </article>
                        <article class="row blog_item">
                            ...
                            <div class="col-md-9">
                                <div class="blog_post">
                                    <img src="${contextRoot}/resources/frontstage/img/blog/main-blog/m-blog-2.jpg" alt="">
                                    <div class="blog_details">
                                        <a href="${contextRoot}/resources/frontstage/single-blog.html">
                        ...
                        <article class="row blog_item">
                            ...
                            <div class="col-md-9">
                                <div class="blog_post">
                                    <img src="${contextRoot}/resources/frontstage/img/blog/main-blog/m-blog-3.jpg" alt="">
                                    <div class="blog_details">
                                        <a href="${contextRoot}/resources/frontstage/single-blog.html">
                        ...
                        <article class="row blog_item">
                            ...
                            <div class="col-md-9">
                                <div class="blog_post">
                                    <img src="${contextRoot}/resources/frontstage/img/blog/main-blog/m-blog-4.jpg" alt="">
                                    <div class="blog_details">
                                        <a href="${contextRoot}/resources/frontstage/single-blog.html">
                                            <h2>The Night Sky</h2>
                                        </a>
                        ...
                        <article class="row blog_item">
                            ...
                            <div class="col-md-9">
                                <div class="blog_post">
                                    <img src="${contextRoot}/resources/frontstage/img/blog/main-blog/m-blog-5.jpg" alt="">
                                    <div class="blog_details">
                                        <a href="${contextRoot}/resources/frontstage/single-blog.html">
                ...
                <div class="col-lg-4">
                    <div class="blog_right_sidebar">
                        ...
                        <aside class="single_sidebar_widget author_widget">
                            <img class="author_img rounded-circle" src="${contextRoot}/resources/frontstage/img/blog/author.png" alt="">
                        ...
                        <aside class="single_sidebar_widget popular_post_widget">
                            ...
                            <div class="media post_item">
                                <img src="${contextRoot}/resources/frontstage/img/blog/popular-post/post1.jpg" alt="post">
                            ...
                            <div class="media post_item">
                                <img src="${contextRoot}/resources/frontstage/img/blog/popular-post/post2.jpg" alt="post">
                                <div class="media-body">
                                    <a href="${contextRoot}/resources/frontstage/blog-details.html">
                            ...
                            <div class="media post_item">
                                <img src="${contextRoot}/resources/frontstage/img/blog/popular-post/post3.jpg" alt="post">
                                <div class="media-body">
                                    <a href="${contextRoot}/resources/frontstage/blog-details.html">
                            ...
                            <div class="media post_item">
                                <img src="${contextRoot}/resources/frontstage/img/blog/popular-post/post4.jpg" alt="post">
                                <div class="media-body">
                                    <a href="${contextRoot}/resources/frontstage/blog-details.html">
                        ...
                        <aside class="single_sidebar_widget ads_widget">
                            <a href="#"><img class="img-fluid" src="${contextRoot}/resources/frontstage/img/blog/add.jpg" alt=""></a>
                            <div class="br"></div>
                        </aside>
