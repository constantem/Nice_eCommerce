            ...
            <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
                <div class="col-first">
                    ...
                    <nav class="d-flex align-items-center">
                        ...
                        <a href="${contextRoot}/resources/frontstage/category.html">Cart</a>
                    </nav>
                </div>
            </div>
        </div>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="media">
                                        <div class="d-flex">
                                            <img src="${contextRoot}/resources/frontstage/img/cart.jpg" alt="">
                                        </div>
                                ...
                                <td>
                                    <div class="product_count">
                                        ...
                                        <button onclick="var result = document.getElementById('sst'); var sst = result.value; if( !isNaN( sst ) &amp&amp  > 0 ) result.value--;return false;"
