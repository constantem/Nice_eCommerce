						...
						<c:forEach items="${pdList}" var="pdList">
							<!-- single product -->
								...
								<div class="single-product">
									<a href="${contextRoot}/getOneProductShop${pdList.id}">
										<img class="pdimg" alt="picture" src="${contextRoot}/ProductTempImg/${pdList.imgUrl}"  onmouseover="this.src=' ${contextRoot}/ProductTempImg/${pdList.imgUrl_A} ';"
										  onmouseout="this.src=' ${contextRoot}/ProductTempImg/${pdList.imgUrl} ';" width="112" />
									</a>
									<!-- 										ProductTempImg -->
									<div id="product-details" class="product-details">
										...
										<div class="prd-bottom">
											...
											<c:choose>
												...
												<c:otherwise>
													<a href="${contextRoot}/user/addMyCartFromShop?productId=${pdList.id}" class="social-info addCart"> 
